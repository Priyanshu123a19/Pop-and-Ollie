...
/**
 * Item in *Board Customizer → Texture*
 */
export interface BoardCustomizerDocumentDataTextureItem {
  /**
   * Color field in *Board Customizer → Texture*
   *
   * - **Field Type**: Color
   * - **Placeholder**: *None*
   * - **API ID Path**: board_customizer.texture[].colors
   * - **Documentation**: https://prismic.io/docs/fields/color
   */
  colors: prismic.ColorField;

  /**
   * UID field in *Board Customizer → Texture*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: board_customizer.texture[].uid
   * - **Documentation**: https://prismic.io/docs/fields/text
   */
  uid: prismic.KeyTextField;
}
...
interface BoardCustomizerDocumentData {
   ...
   * Texture field in *Board Customizer*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: board_customizer.texture[]
   * - **Tab**: Texture
   * - **Documentation**: https://prismic.io/docs/fields/repeatable-group
   */;
  texture: prismic.GroupField<Simplify<BoardCustomizerDocumentDataTextureItem>>;
}
...
interface SkateboardDocumentData {
  ...
  /**
   * Customizer_Link field in *Skateboard*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      BoardCustomizerDocumentDataTextureItem,
      HomepageDocument,
